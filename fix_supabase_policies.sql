...
-- ✅ تفعيل القراءة العامة للشعارات
ALTER TABLE logos ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "Allow public read access to logos" ON logos;
...
DROP POLICY IF EXISTS "Allow admin full access to logos" ON logos;
