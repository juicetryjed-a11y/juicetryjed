-- التحقق من الجداول وإصلاحها
-- Check and fix tables for user management
...
-- إنشاء Policies إذا لم تكن موجودة
